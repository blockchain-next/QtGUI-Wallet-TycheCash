...
void SendFrame::sendClicked() {
  QVector<TycheCash::WalletLegacyTransfer> walletTransfers;
  Q_FOREACH (TransferFrame * transfer, m_transfers) {
    ...
    TycheCash::WalletLegacyTransfer walletTransfer;
...
void SendFrame::sendTransactionCompleted(TycheCash::TransactionId _id, bool _error, const QString& _errorText) {
  Q_UNUSED(_id);
  if (_error) {
    QCoreApplication::postEvent(
      &MainWindow::instance(),
