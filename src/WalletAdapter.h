...
class WalletAdapter : public QObject, public TycheCash::IWalletLegacyObserver {
  Q_OBJECT
...
public:
  ...
  bool getTransaction(TycheCash::TransactionId& _id, TycheCash::WalletLegacyTransaction& _transaction);
  bool getTransfer(TycheCash::TransferId& _id, TycheCash::WalletLegacyTransfer& _transfer);
  bool isOpen() const;
  void sendTransaction(const QVector<TycheCash::WalletLegacyTransfer>& _transfers, quint64 _fee, const QString& _payment_id, quint64 _mixin);
  ...
  void externalTransactionCreated(TycheCash::TransactionId _transaction_id) Q_DECL_OVERRIDE;
  void sendTransactionCompleted(TycheCash::TransactionId _transaction_id, std::error_code _result) Q_DECL_OVERRIDE;
  void transactionUpdated(TycheCash::TransactionId _transaction_id) Q_DECL_OVERRIDE;
...
private:
  ...
  void onWalletSendTransactionCompleted(TycheCash::TransactionId _transaction_id, int _error, const QString& _error_text);
...
Q_SIGNALS:
  ...
  void walletTransactionCreatedSignal(TycheCash::TransactionId _transaction_id);
  void walletSendTransactionCompletedSignal(TycheCash::TransactionId _transaction_id, int _error, const QString& _error_text);
  void walletTransactionUpdatedSignal(TycheCash::TransactionId _transaction_id);
